...
st.set_page_config(page_title= "HRM", page_icon=":smiley:" , layout= "wide", initial_sidebar_state= "expanded",
                   menu_items={'About': """# This Streamlit page is created by *Srinath"""})
st.markdown("<h1 style='text-align: center; color: Yellow;'>Workforce HR Geo-Visualization</h1>", unsafe_allow_html=True)

data = pd.read_csv(r"D:/Projects/Location Based HR analysis/FINAL_HR.CSV")
...
fig = px.bar(main_data_melted, x='State', y='Count', color='WorkerType', 
             ...
             color_discrete_sequence=['#E6E6FA', '#FFD580', '#006400'],
